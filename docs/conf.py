...
# html_baseurl will define the canonical url of our built docs pages.  We always set our canonical
# rel pages to point to latest.  Many search engines use this to generally skip indexing old pages
# in favor of the latest docs, and to generally provide links to the latest docs rather than old
# docs.  This is good because it means our search results stay pretty up-to-date, but it also means
# that we have to keep a good system of redirects for search results that point to no-longer-valid
# links.
html_baseurl = "https://docs.determined.ai/latest"
...
# language by default. We don't use language in the published URL.
